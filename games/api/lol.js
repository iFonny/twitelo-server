...
module.exports.getAccountInfo = (gameID, settings) => {
  return new Promise((resolve, reject) => {
    Server.fn.game[gameID]
      .getSummonerByName(settings.username, settings.region)
      .then(accountInfo => {
...
module.exports.getDataOneByOne = async (
  ...
  if (
    ...
    tag_ids.LOL__RANKED_SOLO_SR__WINS ||
    ...
    tag_ids.LOL__RANKED_FLEX_SR__WINS ||
    ...
    tag_ids.LOL__RANKED_FLEX_TT__WINS ||
    tag_ids.LOL__RANKED_FLEX_TT__LOSSES ||
    tag_ids.LOL__RANKED_FLEX_TT__GAMES ||
    ...
    try {
      ...
      if (summoner) {
        ...
        if (tag_ids.LOL__OPGG__SEASON_TIER) {
          await Server.fn.game.utils.updateGameData(
            summoner.seasons[data_settings.season],
