...
const dataFunction = {
  ...
  timeFormat: {
    default: data => data,
    h_m_s_dots: data =>
      Server.moment.duration(parseFloat(data), 'seconds').format('h:m:s', {
        trim: 'both mid',
      }),
    h_mm_ss_dots: data =>
      Server.moment.duration(parseFloat(data), 'seconds').format('h:mm:ss', {
        trim: 'both mid',
      }),
    h_m_s_ms_dots: data =>
      Server.moment.duration(parseFloat(data), 'seconds').format('h:m:s:SSS', {
        trim: 'both mid',
      }),
    h_mm_ss_ms_dots: data =>
      Server.moment
        .duration(parseFloat(data), 'seconds')
        .format('h:mm:ss:SSS', {
          trim: 'both mid',
        }),
    h_m_s: data =>
  ...
  ordinal: {
    ...
    withOrdinal: data =>
      data +
      (['st', 'nd', 'rd'][
        (((((parseInt(data) < 0 ? -parseInt(data) : parseInt(data)) + 90) %
          100) -
          10) %
          10) -
          1
