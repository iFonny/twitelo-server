  ...
  checkParamsContact(params, user) {
    return new Promise((resolve, reject) => {
      ...
      if (
        ...
        params.username.length <= 50
      )
        contactData.username = params.username;
      else
        return reject(Server.fn.api.jsonError(400, 'Bad or Missing username'));
      ...
      if (
        ...
        contactData.message = params.message;
      else
        return reject(Server.fn.api.jsonError(400, 'Bad or Missing message'));
